  ...
  return (
    <div className="">
      <div
        ...
        style={{
          maxWidth: "600px",
          filter: existingDataPopup ? "blur(1px)" : "none",
          pointerEvents: existingDataPopup ? "none" : "auto",
        }}
      >
        ...
        <Popup
          className="d-flex justify-content-end align-align-items-center me-4"
          open={isopen}
        ...
        >
          <div>
            <h4 className="text-danger mb-3">{existingDataMessage}</h4>
            <p className="mb-2">Your data is already registered with us.</p>
            <p className="mb-2">Please contact our HR team.</p>
            <div
              className="text-start mt-3 mb-3 text-center"
              style={{ fontSize: "1rem" }}
            >
              <p>
